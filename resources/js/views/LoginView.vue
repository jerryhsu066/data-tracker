<template>
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-sm bg-white rounded-2xl shadow-lg p-8">
            ...
            <p class="text-slate-500 text-sm mb-6">Sign in to your stock tracker</p>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <p v-if="generalError" class="text-sm text-red-500 bg-red-50 rounded-lg px-3 py-2">{{ generalError }}</p>
