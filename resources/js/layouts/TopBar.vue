<template>
    <header class="fixed top-0 inset-x-0 z-50 h-12 bg-white dark:bg-gray-950 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4">
        <!-- Left: hamburger (mobile) + brand -->
        <div class="flex items-center gap-3">
            <button
                class="md:hidden p-1.5 rounded-md text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            ...
            <span class="flex items-center gap-2 font-bold text-lg tracking-tight text-slate-900 dark:text-white select-none">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-6 h-6 shrink-0">
        ...
        <div class="flex items-center gap-1.5">
            ...
            <div class="relative" ref="privacyRef">
                <button
                    ...
                    class="p-1.5 rounded-md text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors leading-none"
                ...
                <div
                    ...
                    class="absolute right-0 top-full mt-1 w-56 bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg p-3 z-50"
                >
                    <p class="text-xs text-slate-500 dark:text-slate-400 mb-2">Enter your password to show amounts</p>
                    <input
                        v-model="unlockPassword"
                        type="password"
                        placeholder="Password"
                        class="h-8 w-full rounded-md border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-gray-950 text-slate-900 dark:text-slate-100 px-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 mb-2"
            ...
            <button
                @click="theme.toggle()"
                class="p-1.5 rounded-md text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-base leading-none"
            ...
            <div class="relative hidden sm:block" ref="userMenuRef">
                <button
                    ...
                    class="flex items-center gap-1.5 px-2 py-1 rounded-md text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-sm"
                >
                ...
                <div
                    v-if="userMenuOpen"
                    class="absolute right-0 top-full mt-1 w-44 bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg py-1 z-50"
                >
                    <RouterLink
                        to="/user/settings"
                        class="flex items-center gap-2 px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                    ...
                    <button
                        @click="handleLogout"
                        class="w-full flex items-center gap-2 px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
